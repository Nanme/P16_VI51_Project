...
import fr.utbm.vi51.prj.drone.ia.evt.AbstractMobileObject;
...
import fr.utbm.vi51.prj.drone.ia.evt.MobileObject;
...
public abstract class AbstractEnv implements Environment {
	 ...
	 */
	public AbstractEnv(float width, float height, TimeManager timeManager) {
		this.width = width;
		this.height = height;
